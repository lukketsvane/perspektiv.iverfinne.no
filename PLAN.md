...
- **seks nye scener + klutter-pass** (v1.9, 26 presetar): sirkus (manesjering av 14 bogesegment, elefant av boksar med ryttar, artist på podium, tribune i to sektorar med trappa benkerader, master med banner; ringside-froskeblikk, manesje-, tribune- og publikumsblikk), hamnekai (skrog som ruvar over hovudhøgd på kaia, styrhus/mast/dekkslast, skiff for djupn, pullertrekkje, fiskekassestablar, davit, fiskarar i arbeid; kai-, froske-, dekks- og kantblikk), leikeplass (klatrestativ-grid, huskestativ med barn på setet, sandkasse, sklietårn — born i 0.58–0.74-skala, foreldre ved benken; barneauge-, forelder-, froske- og tårnblikk), museum (tre veggar, beist-skjelett på podium — ribbekasse 1.6×1.5×4.2 m på tjukke bein, hals og hovud i takhøgd — sokklar med gjenstandar, veggrammer, monter, vitjarar; under-beistet-, vitjar-, midtsal- og hjørneblikk), bilverkstad (bil på tosøyla løftebukk med mekanikar STÅANDE UNDER, golvbil med oppslått panser, dekkstablar, motorheis med hengande blokk, benk med verktøy; på-ryggen-under-bilen-blikket m.fl.), festsal (to langbord med gjester på begge sider, dekketøy, hovudbord på pall, golvkandelaber, kelnarar; gjesteblikk i stolrekkja, kelner-, hovudbord- og froskeblikk). klutter-pass: stall (høyballar, bøtter, fôrtrau), containerhamn (pallar med last, oljefat), kontor (koppar og papirbunker på pultane), perrong (skiltstolpar, automat), hovudstudie (arbeidsbord med verktøy, krakk), figurrekkje (observerande teiknar bak staffeli). `buildGreatPreset` prøver 12 gonger (før 10); kvalitetsgarantien dekkjer automatisk 26 × 30 seed.

- **seks scener til + synspunkt-pass** (v2.0, 32 presetar): symjehall (basseng med heva kant, startpallar, stupetårn med stupar på kanten, svikt, badevaktstol, folk på dekket; STUPET frå 6.4 m), gymsal (ribbevegg av stolpar og trinn, kasse i tre lag med svikt og matter, bom med balanserande barn, benker, born i barneskala), søylehall (4×3 tjukke søyler på basar, bjelkar, hengjande lampar, teppe, sitjande rader — froskeblikk ved søylefoten der søylene konvergerer), orkester (dirigent på podium, to bogar av sitjande musikarar med notestativ, flygel med open lok på tre bein, pauker, kontrabass; dirigent-, musikar-, froske- og paukeblikk), lager (tre reolgater med stolpar/hyllebjelkar/last, gaffeltruck med pall heva til 2 m — froskeblikk under lasta — jekketralle, arbeidarar), bussterminal (tre bussar i skrå rekkje, kø med kofferter mot døra, leskur med benk, skilt og automat; kø-, barneauge-, busskløft- og leskurblikk). synspunkt-pass: nytt designa blikk i klasserom (froskeblikk mellom pultrekkjene), gate (barneauge ved husveggen), stall (lent over gjerdet), marknad (froskeblikk ved bodstolpen), bibliotek (barneauge i hyllegata) og kjøkken (over kokkeskuldra).

- **leddstilt mannekeng** (v2.1): pakke-evaluering fann berre three.js-baserte bibliotek (mannequin.js) og lukka posering-appar (SetPose, PoseMy.Art) — difor eigen rein modul `mannequin.ts` som byggjer figuren av VÅRE boksar. kjernen fekk valfri `pitch` på Box (rotasjon kring lokal x etter yaw, kring sentroiden — hjørne, obb-plukking, pointInBox, blekkflater og svg er orienterings-generiske) og `grp` som bind delboksar til éin figur; dokumentversjon 3 (v1/v2 les inn utan endring). mannekengen: 16 delar (hovud, hals, ribbekasse, bekken, over-/underarmar, hender, lår, leggar, føter) i 7,5-hovuds kanon, 10 positurar (staande, gaande, springande, sitjande, sitgolv, hukande, boygd, lener, vinkande, berande) definerte som sagittale leddvinklar + sidespreiing; BAKKENORMALISERING (lågaste hjørne vert skuvd eksakt til basisplanet) gjer at positurgeometrien sjølv bestemmer bekkenhøgda — sitjande hamnar i stolhøgd utan eigne høgdetal. bruk: dobbelttapp/dobbelklikk på golvet stemplar mannekeng (før: rein figurboks); `f` stemplar midt i synsfeltet eller byter positur på den valde; flytt/rotér/slett/dupliser verkar på HEILE gruppa (batch-kommando i historikken = eitt angre-steg); enkeltlemmer kan framleis justerast med push/vmove. figurrekkje-presetet er no mannekeng-utstillinga (4–6 figurar i ulike positurar med ±3° jitter), croquis-modellen sit leddstilt på podiet.

- **mannekengar overalt** (v2.2): ALLE folk i alle 32 scenene er no leddstilte mannekengar — `person()` byggjer mannekeng (høgd 1.60–1.90 m × skala for born, ±3° jitter, baseY for heva plassering) og gamle positur-bounding-boxes er borte. Råboks-folk vart òg leddstilte: klasserom-elevar (sitjande ved pultane, ståande småvaksne), skuterføraren i gata (sitjande i salen), badefigurane i interiøret, dei hukande kunstnarane i teiknekvelden, barnet på skuldrene i konserten. Sitjande brukar no som regel `sitjande` med bakkenormalisering (føtene på golvet, bekkenet landar på stol-/benkekanten av seg sjølv); ryttarar og folk på huska/tribuna får eksplisitt baseY. Dirigenten og sirkusartisten VINKAR, sklietårn-barnet vinkar, gymsal-barnet GÅR på bommen. Tettleiken i dei tyngste scenene er trimma (folkemengd/konsert/teiknekveld/croquis/festsal/orkester) så dei tyngste scenene ligg på 250–300 boksar; gåande fps målt 47–57 i headless software-rendering (raskare på ekte maskinvare). menneskeskala-testen krev no ≥4 ULIKE mannekeng-høgder i folkemengda.
